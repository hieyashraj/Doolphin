...
export async function GET(_request, { params }) {
  ...
  const variant = await prisma.creationVariant.findFirst({ where: { id: variantId, creationId: id, status: "COMPLETED", creation: { userId: appUser.id } }, include: { artifacts: { where: { type: "FINAL_VIDEO", validationStatus: "VALID" } } } });
